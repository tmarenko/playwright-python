...
class Download(AsyncBase):
    ...
    def uuid(self) -> str:
        ...
        Returns unique download's filename which is a random GUID generated by `Browser.downloadWillBegin` event.
        -------
        str
        """
        return mapping.from_maybe_impl(self._impl_obj.uuid)
